...
from beat_detection.core.detectors.beat_this import BeatThisDetector, BEAT_THIS_FPS
...
def test_beat_this_detector_with_config():
    ...
    with patch('beat_this.inference.File2Beats') as mock_file2beats, \
         patch('beat_detection.core.detectors.beat_this.CustomBeatTrackingProcessor') as mock_processor, \
